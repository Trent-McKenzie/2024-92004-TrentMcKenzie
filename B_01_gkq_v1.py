...
def string_checker(question, valid_ans=('yes', 'no')):
    error = f"Please enter 'yes' or 'no'"
...
- Technology
- Food & Drink
- An extra hard New Zealand related quiz (type nz)
...
def int_check(question):
    while True:
        ...
        error = "Please enter an available topic."
...
if topic == "Food and Drink":
    ...
    round_feedback = f"{user_choice} vs {comp_choice}"
    history_item = f"Round: {rounds_played} - {round_feedback}"

# Game history / Statistics area

    result = quiz_result(user_choice, comp_choice)
